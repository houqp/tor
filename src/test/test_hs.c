...
test_hs_desc_event(void *arg)
{
  ...
  control_event_hs_descriptor_requested(&rend_query, STR_HS_DIR_LONGNAME,
                                        STR_HS_ID);
  expected_msg =
    "650 HS_DESC REQUESTED "STR_HS_ADDR" 0 "STR_HS_DIR_LONGNAME\
    " "STR_HS_ID"\r\n";
  ...
  expected_msg =
    "650 HS_DESC RECEIVED "STR_HS_ADDR" 0 "STR_HS_DIR_LONGNAME"\r\n";
  test_assert(received_msg);
  test_streq(received_msg, expected_msg);
  tor_free(received_msg);
  received_msg = NULL;
  ...
  expected_msg =
    "650 HS_DESC FAILED "STR_HS_ADDR" 0 "STR_HS_DIR_LONGNAME"\r\n";
  test_assert(received_msg);
  test_streq(received_msg, expected_msg);
  tor_free(received_msg);
  received_msg = NULL;
